...
var grpc = {web: {}}, module$contents$grpc$web$ClientReadableStream_ClientReadableStream = function () {
};
...
var module$contents$grpc$web$Error_Error;
grpc.web.Error = module$contents$grpc$web$Error_Error;
var module$contents$grpc$web$AbstractClientBase_AbstractClientBase = function () {
};
module$contents$grpc$web$AbstractClientBase_AbstractClientBase.MethodInfo = function (a, b, c) {
    this.responseType = a;
    this.requestSerializeFn = b;
    this.responseDeserializeFn = c
};
module$contents$grpc$web$AbstractClientBase_AbstractClientBase.prototype.rpcCall = goog.abstractMethod;
module$contents$grpc$web$AbstractClientBase_AbstractClientBase.prototype.serverStreaming = goog.abstractMethod;
...
var module$contents$grpc$web$GrpcWebStreamParser_GrpcWebStreamParser = function () {
        this.errorMessage_ = null;
        this.result_ = [];
        this.streamPos_ = 0;
        this.state_ = module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.INIT;
        this.countLengthBytes_ = this.length_ = this.frame_ = 0;
        this.messageBuffer_ = null;
        this.countMessageBytes_ = 0
    },
    module$contents$grpc$web$GrpcWebStreamParser_Parser = module$contents$grpc$web$GrpcWebStreamParser_GrpcWebStreamParser;
module$contents$grpc$web$GrpcWebStreamParser_Parser.State_ = {INIT: 0, LENGTH: 1, MESSAGE: 2, INVALID: 3};
...
module$contents$grpc$web$GrpcWebStreamParser_GrpcWebStreamParser.prototype.isInputValid = function () {
    return this.state_ != module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.INVALID
};
module$contents$grpc$web$GrpcWebStreamParser_GrpcWebStreamParser.prototype.getErrorMessage = function () {
    return this.errorMessage_
};
module$contents$grpc$web$GrpcWebStreamParser_Parser.prototype.error_ = function (a, b, c) {
    this.state_ = module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.INVALID;
    this.errorMessage_ = "The stream is broken @" + this.streamPos_ + "/" + b + ". Error: " + c + ". With input:\n" + a;
    throw Error(this.errorMessage_);
};
module$contents$grpc$web$GrpcWebStreamParser_GrpcWebStreamParser.prototype.parse = function (a) {
    function b(a) {
        a == module$contents$grpc$web$GrpcWebStreamParser_FrameType.DATA ? f.frame_ = a : a == module$contents$grpc$web$GrpcWebStreamParser_FrameType.TRAILER ? f.frame_ = a : f.error_(g, h, "invalid frame byte");
        f.state_ = module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.LENGTH;
        f.length_ = 0;
    ...
    function c(a) {
        f.countLengthBytes_++;
        f.length_ = (f.length_ << 8) + a;
        4 == f.countLengthBytes_ && (f.state_ = module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.MESSAGE,
            f.countMessageBytes_ = 0, f.messageBuffer_ = "undefined" !== typeof Uint8Array ? new Uint8Array(f.length_) : Array(f.length_), 0 == f.length_ && e())
    }
    ...
    function e() {
        var a = {};
        a[f.frame_] = f.messageBuffer_;
        f.result_.push(a);
        f.state_ = module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.INIT
    }
    ...
    for (var f = this, g = a instanceof Array ? a : new Uint8Array(a), h = 0; h < g.length;) {
        switch (f.state_) {
            case module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.INVALID:
                f.error_(g,
                    h, "stream already broken");
                break;
            case module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.INIT:
                b(g[h]);
                break;
            case module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.LENGTH:
                c(g[h]);
                break;
            case module$contents$grpc$web$GrpcWebStreamParser_Parser.State_.MESSAGE:
                d(g[h]);
                break;
            default:
...
var module$contents$grpc$web$StatusCode_StatusCode = {
    OK: 0,
    CANCELLED: 1,
    UNKNOWN: 2,
    INVALID_ARGUMENT: 3,
    ...
    UNAVAILABLE: 14,
    DATA_LOSS: 15,
    fromHttpStatus: function (a) {
        switch (a) {
            case 200:
                return module$contents$grpc$web$StatusCode_StatusCode.OK;
            case 400:
                return module$contents$grpc$web$StatusCode_StatusCode.INVALID_ARGUMENT;
            case 401:
                return module$contents$grpc$web$StatusCode_StatusCode.UNAUTHENTICATED;
            case 403:
                return module$contents$grpc$web$StatusCode_StatusCode.PERMISSION_DENIED;
            case 404:
                return module$contents$grpc$web$StatusCode_StatusCode.NOT_FOUND;
            case 409:
                return module$contents$grpc$web$StatusCode_StatusCode.ABORTED;
            case 412:
                return module$contents$grpc$web$StatusCode_StatusCode.FAILED_PRECONDITION;
            case 429:
                return module$contents$grpc$web$StatusCode_StatusCode.RESOURCE_EXHAUSTED;
            case 499:
                return module$contents$grpc$web$StatusCode_StatusCode.CANCELLED;
            case 500:
                return module$contents$grpc$web$StatusCode_StatusCode.UNKNOWN;
            case 501:
                return module$contents$grpc$web$StatusCode_StatusCode.UNIMPLEMENTED;
            case 503:
                return module$contents$grpc$web$StatusCode_StatusCode.UNAVAILABLE;
            case 504:
                return module$contents$grpc$web$StatusCode_StatusCode.DEADLINE_EXCEEDED;
            default:
                return module$contents$grpc$web$StatusCode_StatusCode.UNKNOWN
        }
    }
};
grpc.web.StatusCode = module$contents$grpc$web$StatusCode_StatusCode;
...
goog.structs.Map.prototype.equals = function (a, b) {
    ...
    this.cleanupKeysArray_();
    for (var c, d = 0; c = this.keys_[d]; d++) if (!b(this.get(c), a.get(c))) return !1;
    return !0
};
...
goog.structs.Map.prototype.cleanupKeysArray_ = function () {
    ...
    if (this.count_ != this.keys_.length) {
        var d = {};
        for (b = a = 0; a < this.keys_.length;) c = this.keys_[a], goog.structs.Map.hasKey_(d, c) || (this.keys_[b++] = c, d[c] = 1), a++;
        this.keys_.length = b
    }
};
...
goog.net.XhrIo = function (a) {
    ...
    this.useXhr2Timeout_ = this.progressEventsEnabled_ = this.withCredentials_ =
        !1
};
...
goog.net.XhrIo.prototype.send = function (a, b, c, d) {
    ...
    this.xhr_.withCredentials !== this.withCredentials_ && (this.xhr_.withCredentials = this.withCredentials_);
    try {
        this.cleanUpTimeoutTimer_(), 0 < this.timeoutInterval_ && (this.useXhr2Timeout_ = goog.net.XhrIo.shouldUseXhr2Timeout_(this.xhr_), goog.log.fine(this.logger_, this.formatMsg_("Will abort after " + this.timeoutInterval_ + "ms if incomplete, xhr2 " + this.useXhr2Timeout_)), this.useXhr2Timeout_ ? (this.xhr_[goog.net.XhrIo.XHR2_TIMEOUT_] = this.timeoutInterval_, this.xhr_[goog.net.XhrIo.XHR2_ON_TIMEOUT_] = goog.bind(this.timeout_,
            this)) : this.timeoutId_ = goog.Timer.callOnce(this.timeout_, this.timeoutInterval_, this)), goog.log.fine(this.logger_, this.formatMsg_("Sending request")), this.inSend_ = !0, this.xhr_.send(a), this.inSend_ = !1
    } catch (f) {
...
goog.net.XhrIo.prototype.getResponseHeader = function (a) {
    if (this.xhr_ && this.isComplete()) return a = this.xhr_.getResponseHeader(a), goog.isNull(a) ? void 0 : a
};
goog.net.XhrIo.prototype.getAllResponseHeaders = function () {
    return this.xhr_ && this.isComplete() ? this.xhr_.getAllResponseHeaders() : ""
};
goog.net.XhrIo.prototype.getResponseHeaders = function () {
    for (var a = {}, b = this.getAllResponseHeaders().split("\r\n"), c = 0; c < b.length; c++) if (!goog.string.isEmptyOrWhitespace(b[c])) {
...
grpc.web.Status = {};
var module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS = "grpc-status",
    module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS_MESSAGE = "grpc-message",
    module$contents$grpc$web$GrpcWebClientReadableStream_GrpcWebClientReadableStream = function (a) {
        this.xhr_ = a.xhr;
        this.onEndCallback_ = this.onErrorCallback_ = this.onStatusCallback_ = this.onDataCallback_ = this.responseDeserializeFn_ = null;
        this.pos_ = 0;
        this.parser_ = new module$contents$grpc$web$GrpcWebStreamParser_GrpcWebStreamParser;
        var b = this;
        goog.events.listen(this.xhr_, goog.net.EventType.READY_STATE_CHANGE, function (a) {
            a = module$contents$grpc$web$GrpcWebStreamParser_GrpcWebStreamParser.FrameType;
            var c = b.xhr_.getResponseText(), e = c.length - c.length % 4;
            c = c.substr(b.pos_, e - b.pos_);
            if (0 != c.length && (b.pos_ = e, e = goog.crypt.base64.decodeStringToUint8Array(c), e = b.parser_.parse([].slice.call(e)))) {
                for (c = 0; c < e.length; c++) {
                    if (a.DATA in e[c]) {
                        var f = e[c][a.DATA];
                        if (f && (f = b.responseDeserializeFn_(f))) b.onDataCallback_(f)
                    }
                    if (a.TRAILER in e[c] && 0 < e[c][a.TRAILER].length) {
                        f =
                            "";
                        for (var g = 0; g < e[c][a.TRAILER].length; g++) f += String.fromCharCode(e[c][a.TRAILER][g]);
                        f = b.parseHttp1Headers_(f);
                        g = module$contents$grpc$web$StatusCode_StatusCode.OK;
                        var h = "";
                        module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS in f && (g = f[module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS]);
                        module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS_MESSAGE in f && (h = f[module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS_MESSAGE]);
                        if (b.onStatusCallback_) b.onStatusCallback_({
                            code: Number(g),
                            details: h, metadata: f
                        })
                    }
                }
                if (b.xhr_.getReadyState() == goog.net.XmlHttp.ReadyState.COMPLETE && b.onEndCallback_) b.onEndCallback_()
            }
        });
        goog.events.listen(this.xhr_, goog.net.EventType.COMPLETE, function (a) {
            if (b.onErrorCallback_) if (a = b.xhr_.getLastErrorCode(), a != goog.net.ErrorCode.NO_ERROR) b.onErrorCallback_({
                code: module$contents$grpc$web$StatusCode_StatusCode.UNAVAILABLE,
                message: goog.net.ErrorCode.getDebugMessage(a)
            }); else if (a = b.xhr_.getResponseHeaders(), module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS in
            a && a[module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS] != module$contents$grpc$web$StatusCode_StatusCode.OK) b.onErrorCallback_({
                code: a[module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS],
                message: a[module$contents$grpc$web$GrpcWebClientReadableStream_GRPC_STATUS_MESSAGE]
            })
        })
    };
module$contents$grpc$web$GrpcWebClientReadableStream_GrpcWebClientReadableStream.prototype.on = function (a, b) {
    "data" == a ? this.onDataCallback_ = b : "status" == a ? this.onStatusCallback_ = b : "end" == a ? this.onEndCallback_ = b : "error" == a && (this.onErrorCallback_ = b);
    return this
};
module$contents$grpc$web$GrpcWebClientReadableStream_GrpcWebClientReadableStream.prototype.setResponseDeserializeFn = function (a) {
    this.responseDeserializeFn_ = a
};
module$contents$grpc$web$GrpcWebClientReadableStream_GrpcWebClientReadableStream.prototype.cancel = function () {
    this.xhr_.abort()
};
module$contents$grpc$web$GrpcWebClientReadableStream_GrpcWebClientReadableStream.prototype.parseHttp1Headers_ = function (a) {
    a = a.trim().split("\r\n");
    for (var b = {}, c = 0; c < a.length; c++) {
        var d = a[c].indexOf(":");
        b[a[c].substring(0, d).trim()] = a[c].substring(d + 1).trim()
    }
    return b
};
...
var module$exports$goog$net$rpc$HttpCors = {
    ...
    generateHttpHeadersOverwriteParam: function (a) {
        var b = "";
    ...
    generateEncodedHttpHeadersOverwriteParam: function (a) {
        return goog.string.urlEncode(module$exports$goog$net$rpc$HttpCors.generateHttpHeadersOverwriteParam(a))
    },
    setHttpHeadersWithOverwriteParam: function (a, b, c) {
        if (goog.object.isEmpty(c)) return a;
        c = module$exports$goog$net$rpc$HttpCors.generateHttpHeadersOverwriteParam(c);
        if (goog.isString(a)) return goog.uri.utils.appendParam(a, goog.string.urlEncode(b), c);
        a.setParameterValue(b, c);
        return a
    }
};
var module$contents$grpc$web$GrpcWebClientBase_GrpcWebClientBase = function (a) {
    this.suppressCorsPreflight_ = goog.getObjectByName("suppressCorsPreflight", a) || !1
};
module$contents$grpc$web$GrpcWebClientBase_GrpcWebClientBase.prototype.rpcCall = function (a, b, c, d, e) {
    var f = this.newXhr_();
    b = d.requestSerializeFn(b);
    f.headers.addAll(c);
    c = new module$contents$grpc$web$GrpcWebClientReadableStream_GrpcWebClientReadableStream({xhr: f});
    c.setResponseDeserializeFn(d.responseDeserializeFn);
    c.on("data", function (a) {
        e(null, a)
    });
    c.on("status", function (a) {
        a.code != module$contents$grpc$web$StatusCode_StatusCode.OK && e({code: a.code, message: a.details}, null)
    });
    c.on("error", function (a) {
        a.code !=
        module$contents$grpc$web$StatusCode_StatusCode.OK && e({code: a.code, message: a.message})
    });
    f.headers.set("Content-Type", "application/grpc-web-text");
    f.headers.set("X-User-Agent", "grpc-web-javascript/0.1");
    f.headers.set("Accept", "application/grpc-web-text");
    d = this.encodeRequest_(b);
    d = goog.crypt.base64.encodeByteArray(d);
    this.suppressCorsPreflight_ && (c = f.headers.toObject(), f.headers.clear(), a = module$contents$grpc$web$GrpcWebClientBase_GrpcWebClientBase.setCorsOverride_(a, c));
    f.send(a, "POST", d)
};
module$contents$grpc$web$GrpcWebClientBase_GrpcWebClientBase.prototype.serverStreaming = function (a, b, c, d) {
    ...
    b = d.requestSerializeFn(b);
    e.headers.addAll(c);
    c = new module$contents$grpc$web$GrpcWebClientReadableStream_GrpcWebClientReadableStream({xhr: e});
    c.setResponseDeserializeFn(d.responseDeserializeFn);
    e.headers.set("Content-Type", "application/grpc-web-text");
    e.headers.set("X-User-Agent", "grpc-web-javascript/0.1");
    e.headers.set("Accept", "application/grpc-web-text");
    d = this.encodeRequest_(b);
    d = goog.crypt.base64.encodeByteArray(d);
    this.suppressCorsPreflight_ && (b = e.headers.toObject(), e.headers.clear(), a = module$contents$grpc$web$GrpcWebClientBase_GrpcWebClientBase.setCorsOverride_(a, b));
    e.send(a, "POST", d);
    return c
};
module$contents$grpc$web$GrpcWebClientBase_GrpcWebClientBase.prototype.newXhr_ = function () {
    return new goog.net.XhrIo
};
module$contents$grpc$web$GrpcWebClientBase_GrpcWebClientBase.prototype.encodeRequest_ = function (a) {
    for (var b = a.length, c = [0, 0, 0, 0], d = new Uint8Array(5 + b), e = 3; 0 <= e; e--) c[e] = b % 256, b >>>= 8;
    d.set(new Uint8Array(c), 1);
    d.set(a, 5);
    return d
};
module$contents$grpc$web$GrpcWebClientBase_GrpcWebClientBase.setCorsOverride_ = function (a, b) {
    return module$exports$goog$net$rpc$HttpCors.setHttpHeadersWithOverwriteParam(a, module$exports$goog$net$rpc$HttpCors.HTTP_HEADERS_PARAM_NAME, b)
};
...
jspb.utils.hexStringToHash64 = function (a) {
    ...
    for (var b = "", c = 0; 8 > c; c++) {
        var d = jspb.utils.DIGITS.indexOf(a[2 * c + 2]), e = jspb.utils.DIGITS.indexOf(a[2 * c + 3]);
...
jspb.BinaryDecoder.prototype.readUnsignedVarint32 = function () {
    ...
    b = a[this.cursor_ + 3];
    c |= (b & 127) << 21;
    if (128 > b) return this.cursor_ += 4, goog.asserts.assert(this.cursor_ <=
        this.end_), c;
    b = a[this.cursor_ + 4];
    c |= (b & 15) << 28;
...
jspb.Message.getRepeatedField = function (a, b) {
    ...
    return c === jspb.Message.EMPTY_LIST_SENTINEL_ ? a.extensionObject_[b] = [] : c
};
...
var proto = {customer_ui_api: {}};
proto.customer_ui_api.AckNackResponse = function (a) {
    jspb.Message.initialize(this, a, 0, -1, null, null)
};
goog.inherits(proto.customer_ui_api.AckNackResponse, jspb.Message);
goog.DEBUG && !COMPILED && (proto.customer_ui_api.AckNackResponse.displayName = "proto.customer_ui_api.AckNackResponse");
jspb.Message.GENERATE_TO_OBJECT && (proto.customer_ui_api.AckNackResponse.prototype.toObject = function (a) {
    return proto.customer_ui_api.AckNackResponse.toObject(a, this)
}, proto.customer_ui_api.AckNackResponse.toObject = function (a, b) {
    var c = {acknack: jspb.Message.getFieldWithDefault(b, 1, !1), comments: jspb.Message.getFieldWithDefault(b, 2, "")};
    a && (c.$jspbMessageInstance = b);
    return c
});
proto.customer_ui_api.AckNackResponse.deserializeBinary = function (a) {
    a = new jspb.BinaryReader(a);
    var b = new proto.customer_ui_api.AckNackResponse;
    return proto.customer_ui_api.AckNackResponse.deserializeBinaryFromReader(b, a)
};
proto.customer_ui_api.AckNackResponse.deserializeBinaryFromReader = function (a, b) {
...
proto.customer_ui_api.AckNackResponse.prototype.serializeBinary = function () {
    ...
    proto.customer_ui_api.AckNackResponse.serializeBinaryToWriter(this, a);
    return a.getResultBuffer()
};
proto.customer_ui_api.AckNackResponse.serializeBinaryToWriter = function (a, b) {
    var c;
    (c = a.getAcknack()) && b.writeBool(1, c);
    c = a.getComments();
...
proto.customer_ui_api.AckNackResponse.prototype.setAcknack = function (a) {
    jspb.Message.setProto3BooleanField(this, 1, a)
};
proto.customer_ui_api.AckNackResponse.prototype.getComments = function () {
    return jspb.Message.getFieldWithDefault(this, 2, "")
};
proto.customer_ui_api.AckNackResponse.prototype.setComments = function (a) {
    jspb.Message.setProto3StringField(this, 2, a)
};
proto.customer_ui_api.EmptyParameter = function (a) {
    jspb.Message.initialize(this, a, 0, -1, null, null)
};
goog.inherits(proto.customer_ui_api.EmptyParameter, jspb.Message);
goog.DEBUG && !COMPILED && (proto.customer_ui_api.EmptyParameter.displayName = "proto.customer_ui_api.EmptyParameter");
jspb.Message.GENERATE_TO_OBJECT && (proto.customer_ui_api.EmptyParameter.prototype.toObject = function (a) {
    return proto.customer_ui_api.EmptyParameter.toObject(a, this)
}, proto.customer_ui_api.EmptyParameter.toObject = function (a, b) {
    var c = {};
    a && (c.$jspbMessageInstance = b);
    return c
});
proto.customer_ui_api.EmptyParameter.deserializeBinary = function (a) {
    a = new jspb.BinaryReader(a);
    var b = new proto.customer_ui_api.EmptyParameter;
    return proto.customer_ui_api.EmptyParameter.deserializeBinaryFromReader(b, a)
};
proto.customer_ui_api.EmptyParameter.deserializeBinaryFromReader = function (a, b) {
    for (; b.nextField() && !b.isEndGroup();) b.getFieldNumber(), b.skipField();
    return a
};
proto.customer_ui_api.EmptyParameter.prototype.serializeBinary = function () {
    var a = new jspb.BinaryWriter;
    proto.customer_ui_api.EmptyParameter.serializeBinaryToWriter(this, a);
    return a.getResultBuffer()
};
proto.customer_ui_api.EmptyParameter.serializeBinaryToWriter = function (a, b) {
};
proto.customer_ui_api.HaltPaymentRequest = function (a) {
    jspb.Message.initialize(this, a, 0, -1, null, null)
};
goog.inherits(proto.customer_ui_api.HaltPaymentRequest, jspb.Message);
goog.DEBUG && !COMPILED && (proto.customer_ui_api.HaltPaymentRequest.displayName = "proto.customer_ui_api.HaltPaymentRequest");
jspb.Message.GENERATE_TO_OBJECT && (proto.customer_ui_api.HaltPaymentRequest.prototype.toObject = function (a) {
    return proto.customer_ui_api.HaltPaymentRequest.toObject(a, this)
}, proto.customer_ui_api.HaltPaymentRequest.toObject = function (a, b) {
    var c = {haltpayment: jspb.Message.getFieldWithDefault(b, 1, !1)};
    a && (c.$jspbMessageInstance = b);
    return c
});
proto.customer_ui_api.HaltPaymentRequest.deserializeBinary = function (a) {
    a = new jspb.BinaryReader(a);
    var b = new proto.customer_ui_api.HaltPaymentRequest;
    return proto.customer_ui_api.HaltPaymentRequest.deserializeBinaryFromReader(b, a)
};
proto.customer_ui_api.HaltPaymentRequest.deserializeBinaryFromReader = function (a, b) {
    for (; b.nextField() && !b.isEndGroup();) switch (b.getFieldNumber()) {
        case 1:
            var c = b.readBool();
            a.setHaltpayment(c);
...
proto.customer_ui_api.HaltPaymentRequest.prototype.serializeBinary = function () {
    var a = new jspb.BinaryWriter;
    proto.customer_ui_api.HaltPaymentRequest.serializeBinaryToWriter(this, a);
    return a.getResultBuffer()
};
proto.customer_ui_api.HaltPaymentRequest.serializeBinaryToWriter = function (a, b) {
    (a = a.getHaltpayment()) && b.writeBool(1, a)
};
proto.customer_ui_api.HaltPaymentRequest.prototype.getHaltpayment = function () {
    return jspb.Message.getFieldWithDefault(this, 1, !1)
};
proto.customer_ui_api.HaltPaymentRequest.prototype.setHaltpayment = function (a) {
    jspb.Message.setProto3BooleanField(this, 1, a)
};
proto.customer_ui_api.Price_UI = function (a) {
    jspb.Message.initialize(this, a, 0, -1, null, null)
};
goog.inherits(proto.customer_ui_api.Price_UI, jspb.Message);
goog.DEBUG && !COMPILED && (proto.customer_ui_api.Price_UI.displayName = "proto.customer_ui_api.Price_UI");
jspb.Message.GENERATE_TO_OBJECT && (proto.customer_ui_api.Price_UI.prototype.toObject = function (a) {
    return proto.customer_ui_api.Price_UI.toObject(a, this)
}, proto.customer_ui_api.Price_UI.toObject = function (a, b) {
    var c = {
        acknack: jspb.Message.getFieldWithDefault(b, 1, !1),
        comments: jspb.Message.getFieldWithDefault(b, 2, ""),
        speedAmountSatoshi: jspb.Message.getFieldWithDefault(b, 3, 0),
        accelerationAmountSatoshi: jspb.Message.getFieldWithDefault(b, 4, 0),
        timeAmountSatoshi: jspb.Message.getFieldWithDefault(b, 5, 0),
        speedAmountSek: +jspb.Message.getFieldWithDefault(b,
            6, 0),
        accelerationAmountSek: +jspb.Message.getFieldWithDefault(b, 7, 0),
        timeAmountSek: +jspb.Message.getFieldWithDefault(b, 8, 0),
        timeunit: jspb.Message.getFieldWithDefault(b, 9, 0),
        paymentrequestinterval: jspb.Message.getFieldWithDefault(b, 10, 0),
        priceunit: jspb.Message.getFieldWithDefault(b, 11, 0)
    };
    a && (c.$jspbMessageInstance = b);
    return c
});
proto.customer_ui_api.Price_UI.deserializeBinary = function (a) {
    a = new jspb.BinaryReader(a);
    var b = new proto.customer_ui_api.Price_UI;
    return proto.customer_ui_api.Price_UI.deserializeBinaryFromReader(b, a)
};
proto.customer_ui_api.Price_UI.deserializeBinaryFromReader = function (a, b) {
    for (; b.nextField() && !b.isEndGroup();) switch (b.getFieldNumber()) {
        case 1:
            var c = b.readBool();
            a.setAcknack(c);
        ...
        case 3:
            c = b.readInt64();
            a.setSpeedAmountSatoshi(c);
            break;
        case 4:
            c = b.readInt64();
            a.setAccelerationAmountSatoshi(c);
            break;
        case 5:
            c = b.readInt64();
            a.setTimeAmountSatoshi(c);
            break;
        case 6:
            c = b.readFloat();
            a.setSpeedAmountSek(c);
            break;
        case 7:
            c = b.readFloat();
            a.setAccelerationAmountSek(c);
            break;
        case 8:
            c = b.readFloat();
            a.setTimeAmountSek(c);
            break;
        case 9:
            c = b.readEnum();
            a.setTimeunit(c);
...
proto.customer_ui_api.Price_UI.prototype.serializeBinary = function () {
    var a = new jspb.BinaryWriter;
    proto.customer_ui_api.Price_UI.serializeBinaryToWriter(this, a);
    return a.getResultBuffer()
};
proto.customer_ui_api.Price_UI.serializeBinaryToWriter = function (a, b) {
    var c;
    (c = a.getAcknack()) && b.writeBool(1, c);
    c = a.getComments();
    0 < c.length && b.writeString(2, c);
    c = a.getSpeedAmountSatoshi();
    0 !== c && b.writeInt64(3, c);
    c = a.getAccelerationAmountSatoshi();
    0 !== c && b.writeInt64(4, c);
    c = a.getTimeAmountSatoshi();
    0 !== c && b.writeInt64(5, c);
    c = a.getSpeedAmountSek();
    0 !== c && b.writeFloat(6, c);
    c = a.getAccelerationAmountSek();
    0 !== c && b.writeFloat(7, c);
    c = a.getTimeAmountSek();
    0 !== c && b.writeFloat(8, c);
    c = a.getTimeunit();
    0 !==
    c && b.writeEnum(9, c);
    c = a.getPaymentrequestinterval();
    0 !== c && b.writeInt32(10, c);
    c = a.getPriceunit();
    0 !== c && b.writeEnum(11, c)
};
proto.customer_ui_api.Price_UI.prototype.getAcknack = function () {
    return jspb.Message.getFieldWithDefault(this, 1, !1)
};
proto.customer_ui_api.Price_UI.prototype.setAcknack = function (a) {
    jspb.Message.setProto3BooleanField(this, 1, a)
};
proto.customer_ui_api.Price_UI.prototype.getComments = function () {
    return jspb.Message.getFieldWithDefault(this, 2, "")
};
proto.customer_ui_api.Price_UI.prototype.setComments = function (a) {
    jspb.Message.setProto3StringField(this, 2, a)
};
proto.customer_ui_api.Price_UI.prototype.getSpeedAmountSatoshi = function () {
    return jspb.Message.getFieldWithDefault(this, 3, 0)
};
proto.customer_ui_api.Price_UI.prototype.setSpeedAmountSatoshi = function (a) {
    jspb.Message.setProto3IntField(this, 3, a)
};
...
proto.customer_ui_api.Price_UI.prototype.setAccelerationAmountSatoshi = function (a) {
    jspb.Message.setProto3IntField(this, 4, a)
};
proto.customer_ui_api.Price_UI.prototype.getTimeAmountSatoshi = function () {
    return jspb.Message.getFieldWithDefault(this, 5, 0)
};
proto.customer_ui_api.Price_UI.prototype.setTimeAmountSatoshi = function (a) {
    jspb.Message.setProto3IntField(this, 5, a)
};
proto.customer_ui_api.Price_UI.prototype.getSpeedAmountSek = function () {
    return +jspb.Message.getFieldWithDefault(this, 6, 0)
};
proto.customer_ui_api.Price_UI.prototype.setSpeedAmountSek = function (a) {
    jspb.Message.setProto3FloatField(this, 6, a)
};
...
proto.customer_ui_api.Price_UI.prototype.setAccelerationAmountSek = function (a) {
    jspb.Message.setProto3FloatField(this, 7, a)
};
proto.customer_ui_api.Price_UI.prototype.getTimeAmountSek = function () {
    return +jspb.Message.getFieldWithDefault(this, 8, 0)
};
proto.customer_ui_api.Price_UI.prototype.setTimeAmountSek = function (a) {
    jspb.Message.setProto3FloatField(this, 8, a)
};
proto.customer_ui_api.Price_UI.prototype.getTimeunit = function () {
    return jspb.Message.getFieldWithDefault(this, 9, 0)
};
proto.customer_ui_api.Price_UI.prototype.setTimeunit = function (a) {
    jspb.Message.setProto3EnumField(this, 9, a)
};
...
proto.customer_ui_api.Price_UI.prototype.setPaymentrequestinterval = function (a) {
    jspb.Message.setProto3IntField(this, 10, a)
};
proto.customer_ui_api.Price_UI.prototype.getPriceunit = function () {
    return jspb.Message.getFieldWithDefault(this, 11, 0)
};
proto.customer_ui_api.Price_UI.prototype.setPriceunit = function (a) {
    jspb.Message.setProto3EnumField(this, 11, a)
};
proto.customer_ui_api.Customer_UIClient = function (a, b, c) {
    this.client_ = new module$contents$grpc$web$GrpcWebClientBase_GrpcWebClientBase(c);
    this.hostname_ = a;
    this.credentials_ = b;
    this.options_ = c
};
$jscomp.scope.methodInfo_AskTaxiForPrice = new module$contents$grpc$web$AbstractClientBase_AbstractClientBase.MethodInfo(proto.customer_ui_api.Price_UI, function (a) {
    return a.serializeBinary()
}, proto.customer_ui_api.Price_UI.deserializeBinary);
proto.customer_ui_api.Customer_UIClient.prototype.askTaxiForPrice = function (a, b, c) {
    return this.client_.rpcCall(this.hostname_ + "/customer_ui_api.Customer_UI/AskTaxiForPrice", a, b, $jscomp.scope.methodInfo_AskTaxiForPrice, c)
};
$jscomp.scope.methodInfo_AcceptPrice = new module$contents$grpc$web$AbstractClientBase_AbstractClientBase.MethodInfo(proto.customer_ui_api.AckNackResponse, function (a) {
    return a.serializeBinary()
}, proto.customer_ui_api.AckNackResponse.deserializeBinary);
proto.customer_ui_api.Customer_UIClient.prototype.acceptPrice = function (a, b, c) {
    return this.client_.rpcCall(this.hostname_ + "/customer_ui_api.Customer_UI/AcceptPrice", a, b, $jscomp.scope.methodInfo_AcceptPrice, c)
};
$jscomp.scope.methodInfo_HaltPayments = new module$contents$grpc$web$AbstractClientBase_AbstractClientBase.MethodInfo(proto.customer_ui_api.AckNackResponse, function (a) {
    return a.serializeBinary()
}, proto.customer_ui_api.AckNackResponse.deserializeBinary);
proto.customer_ui_api.Customer_UIClient.prototype.haltPayments = function (a, b, c) {
    return this.client_.rpcCall(this.hostname_ + "/customer_ui_api.Customer_UI/HaltPayments", a, b, $jscomp.scope.methodInfo_HaltPayments, c)
};
$jscomp.scope.methodInfo_LeaveTaxi = new module$contents$grpc$web$AbstractClientBase_AbstractClientBase.MethodInfo(proto.customer_ui_api.AckNackResponse, function (a) {
    return a.serializeBinary()
}, proto.customer_ui_api.AckNackResponse.deserializeBinary);
proto.customer_ui_api.Customer_UIClient.prototype.leaveTaxi = function (a, b, c) {
    return this.client_.rpcCall(this.hostname_ + "/customer_ui_api.Customer_UI/LeaveTaxi", a, b, $jscomp.scope.methodInfo_LeaveTaxi, c)
};
