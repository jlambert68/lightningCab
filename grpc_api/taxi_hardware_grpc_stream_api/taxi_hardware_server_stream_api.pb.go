...
func (TestOrProdEnviroment) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5badbce13cf559ae, []int{0}
}
...
func (*MessasurePowerMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_5badbce13cf559ae, []int{1}
}
...
func (m *MessasurePowerMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MessasurePowerMessage.Merge(m, src)
}
...
func (*PowerStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5badbce13cf559ae, []int{2}
}
...
func (m *PowerStatusResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PowerStatusResponse.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("taxi_hardware_server_stream_api.proto", fileDescriptor_5badbce13cf559ae)
}

var fileDescriptor_5badbce13cf559ae = []byte{
