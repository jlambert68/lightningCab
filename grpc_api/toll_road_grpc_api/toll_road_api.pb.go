...
func (TestOrProdEnviroment) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_api_5f4784f50ce60738, []int{0}
}
...
func (*AckNackResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_api_5f4784f50ce60738, []int{1}
}
...
func (*PaymentRequestMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_api_5f4784f50ce60738, []int{2}
}
...
func (dst *PaymentRequestMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PaymentRequestMessage.Merge(dst, src)
}
...
type Enviroment struct {
	TestOrProduction     TestOrProdEnviroment `protobuf:"varint,1,opt,name=TestOrProduction,proto3,enum=toll_road_grpc_api.TestOrProdEnviroment" json:"TestOrProduction,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (*Enviroment) Descriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_api_5f4784f50ce60738, []int{3}
}
...
// TollRoadServerClient is the client API for TollRoadServer service.
//
...
func (c *tollRoadServerClient) GetPaymentRequest(ctx context.Context, in *Enviroment, opts ...grpc.CallOption) (*PaymentRequestMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/toll_road_grpc_api.TollRoadServer/GetPaymentRequest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// TollRoadServerServer is the server API for TollRoadServer service.
...
func init() { proto.RegisterFile("toll_road_api.proto", fileDescriptor_toll_road_api_5f4784f50ce60738) }

var fileDescriptor_toll_road_api_5f4784f50ce60738 = []byte{
