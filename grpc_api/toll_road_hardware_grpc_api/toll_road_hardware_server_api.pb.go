...
func (TestOrProdEnviroment) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_hardware_server_api_60bc8693bdeaf699, []int{0}
}
...
func (TollGateCommand) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_hardware_server_api_60bc8693bdeaf699, []int{1}
}
...
func (DistanceSensorCommand) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_hardware_server_api_60bc8693bdeaf699, []int{2}
}
...
func (EInkMessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_hardware_server_api_60bc8693bdeaf699, []int{3}
}
...
type Enviroment struct {
	TestOrProduction     TestOrProdEnviroment `protobuf:"varint,1,opt,name=TestOrProduction,proto3,enum=toll_road_hardware_grpc_api.TestOrProdEnviroment" json:"TestOrProduction,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
type TollGateServoMessage struct {
	TollGateServoEnviroment TestOrProdEnviroment `protobuf:"varint,1,opt,name=tollGateServoEnviroment,proto3,enum=toll_road_hardware_grpc_api.TestOrProdEnviroment" json:"tollGateServoEnviroment,omitempty"`
	TollGateCommand         TollGateCommand      `protobuf:"varint,2,opt,name=tollGateCommand,proto3,enum=toll_road_hardware_grpc_api.TollGateCommand" json:"tollGateCommand,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}             `json:"-"`
	XXX_unrecognized        []byte               `json:"-"`
	XXX_sizecache           int32                `json:"-"`
}
...
func (*TollGateServoMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_hardware_server_api_60bc8693bdeaf699, []int{3}
}
func (m *TollGateServoMessage) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TollGateServoMessage.Unmarshal(m, b)
}
func (m *TollGateServoMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TollGateServoMessage.Marshal(b, m, deterministic)
}
func (dst *TollGateServoMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TollGateServoMessage.Merge(dst, src)
}
func (m *TollGateServoMessage) XXX_Size() int {
	return xxx_messageInfo_TollGateServoMessage.Size(m)
}
func (m *TollGateServoMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_TollGateServoMessage.DiscardUnknown(m)
}

var xxx_messageInfo_TollGateServoMessage proto.InternalMessageInfo
...
type DistanceSensorMessage struct {
	DistanceSensorEnviroment TestOrProdEnviroment  `protobuf:"varint,1,opt,name=distanceSensorEnviroment,proto3,enum=toll_road_hardware_grpc_api.TestOrProdEnviroment" json:"distanceSensorEnviroment,omitempty"`
	DistanceSensorCommand    DistanceSensorCommand `protobuf:"varint,2,opt,name=distanceSensorCommand,proto3,enum=toll_road_hardware_grpc_api.DistanceSensorCommand" json:"distanceSensorCommand,omitempty"`
	XXX_NoUnkeyedLiteral     struct{}              `json:"-"`
	XXX_unrecognized         []byte                `json:"-"`
	XXX_sizecache            int32                 `json:"-"`
}
...
func (*DistanceSensorMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_hardware_server_api_60bc8693bdeaf699, []int{4}
}
func (m *DistanceSensorMessage) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DistanceSensorMessage.Unmarshal(m, b)
}
func (m *DistanceSensorMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DistanceSensorMessage.Marshal(b, m, deterministic)
}
func (dst *DistanceSensorMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DistanceSensorMessage.Merge(dst, src)
}
func (m *DistanceSensorMessage) XXX_Size() int {
	return xxx_messageInfo_DistanceSensorMessage.Size(m)
}
func (m *DistanceSensorMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_DistanceSensorMessage.DiscardUnknown(m)
}

var xxx_messageInfo_DistanceSensorMessage proto.InternalMessageInfo
...
type EInkDisplayMessage struct {
	EInkDisplayEnviroment TestOrProdEnviroment `protobuf:"varint,1,opt,name=eInkDisplayEnviroment,proto3,enum=toll_road_hardware_grpc_api.TestOrProdEnviroment" json:"eInkDisplayEnviroment,omitempty"`
	MessageType           EInkMessageType      `protobuf:"varint,2,opt,name=messageType,proto3,enum=toll_road_hardware_grpc_api.EInkMessageType" json:"messageType,omitempty"`
...
func (*EInkDisplayMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_toll_road_hardware_server_api_60bc8693bdeaf699, []int{5}
}
func (m *EInkDisplayMessage) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_EInkDisplayMessage.Unmarshal(m, b)
}
func (m *EInkDisplayMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_EInkDisplayMessage.Marshal(b, m, deterministic)
}
func (dst *EInkDisplayMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EInkDisplayMessage.Merge(dst, src)
}
func (m *EInkDisplayMessage) XXX_Size() int {
	return xxx_messageInfo_EInkDisplayMessage.Size(m)
}
func (m *EInkDisplayMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_EInkDisplayMessage.DiscardUnknown(m)
}

var xxx_messageInfo_EInkDisplayMessage proto.InternalMessageInfo
...
// TollHardwareClient is the client API for TollHardware service.
//
...
func (c *tollHardwareClient) CheckTollGateServo(ctx context.Context, in *Enviroment, opts ...grpc.CallOption) (*AckNackResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/toll_road_hardware_grpc_api.TollHardware/CheckTollGateServo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tollHardwareClient) CheckTollDistanceSensor(ctx context.Context, in *Enviroment, opts ...grpc.CallOption) (*AckNackResponse, error) {
	out := new(AckNackResponse)
	err := c.cc.Invoke(ctx, "/toll_road_hardware_grpc_api.TollHardware/CheckTollDistanceSensor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tollHardwareClient) CheckTollEInkDisplay(ctx context.Context, in *Enviroment, opts ...grpc.CallOption) (*AckNackResponse, error) {
	out := new(AckNackResponse)
	err := c.cc.Invoke(ctx, "/toll_road_hardware_grpc_api.TollHardware/CheckTollEInkDisplay", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tollHardwareClient) OpenCloseTollGateServo(ctx context.Context, in *TollGateServoMessage, opts ...grpc.CallOption) (*AckNackResponse, error) {
	out := new(AckNackResponse)
	err := c.cc.Invoke(ctx, "/toll_road_hardware_grpc_api.TollHardware/OpenCloseTollGateServo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tollHardwareClient) UseDistanceSensor(ctx context.Context, in *DistanceSensorMessage, opts ...grpc.CallOption) (*AckNackResponse, error) {
	out := new(AckNackResponse)
	err := c.cc.Invoke(ctx, "/toll_road_hardware_grpc_api.TollHardware/UseDistanceSensor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tollHardwareClient) UseEInkDisplay(ctx context.Context, in *EInkDisplayMessage, opts ...grpc.CallOption) (*AckNackResponse, error) {
	out := new(AckNackResponse)
	err := c.cc.Invoke(ctx, "/toll_road_hardware_grpc_api.TollHardware/UseEInkDisplay", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// TollHardwareServer is the server API for TollHardware service.
...
func init() {
	proto.RegisterFile("toll_road_hardware_server_api.proto", fileDescriptor_toll_road_hardware_server_api_60bc8693bdeaf699)
}

var fileDescriptor_toll_road_hardware_server_api_60bc8693bdeaf699 = []byte{
